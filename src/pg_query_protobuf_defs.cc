...
static void _outAlterTypeStmt(pg_query::AlterTypeStmt * out_node, const AlterTypeStmt *node);
...
static void _outAlterStatsStmt(pg_query::AlterStatsStmt * out_node, const AlterStatsStmt *node);
...
static void
_outAlterTypeStmt(pg_query::AlterTypeStmt * out_node, const AlterTypeStmt *node)
{
  WRITE_LIST_FIELD(type_name, typeName);
  WRITE_LIST_FIELD(options, options);
}
...
static void
_outAlterStatsStmt(pg_query::AlterStatsStmt * out_node, const AlterStatsStmt *node)
{
  WRITE_LIST_FIELD(defnames, defnames);
